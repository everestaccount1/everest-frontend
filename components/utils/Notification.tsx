...
const Notification = () => {
  ...
  return (
    <div className={`z-20 toast toast-top toast-end ${showNotification ? '' : 'invisible'}`}>
      <div className={`border-2 bg-base-100 rounded-md p-5 ${notification?.type === 'error' ? 'border-error' : 'border-success'} flex items-start shadow-xl max-w-sm break-words`}>
